...
<ul class="menu">
    ...
    <li class="sidebar-item has-sub">
        ...
        <ul class="submenu">
            ...
            <li class="submenu-item sidebar-item has-sub">
                <a href="#" class='sidebar-link'> {{__('Addmission')}}</a>
                <ul class="submenu">
                    <li class="py-1"><a href="{{route(currentUser().'.addmission.index')}}">{{__('List')}}</a></li>
                </ul>
            </li>
            <li class="submenu-item sidebar-item has-sub">
                <a href="#" class='sidebar-link'> {{__('Menu Setting')}}</a>
                <ul class="submenu">
                    <li class="py-1"><a href="{{route(currentUser().'.header.index')}}">{{__('List')}}</a></li>
                </ul>
            </li>
        </ul>
    </li>
