...
use App\Http\Controllers\AddmissionController as addmission;
use App\Http\Controllers\HeaderSectionController as header;
...
Route::group(['middleware'=>isAdmin::class],function(){
    Route::prefix('admin')->group(function(){
        ...
        Route::resource('addmission',addmission::class,['as'=>'admin']);
        Route::resource('header',header::class,['as'=>'admin']);
